...
const ogImagePath = 'src/images/og.png';
...
const Head = ({ metadata }) => (
  <Helmet>
    ...
    <link rel="canonical" href="https://mikaelacarino.com" />
    ...
    <meta property="og:image" content={`${config.siteUrl}${ogImagePath}?v=${Date.now()}`} />
    ...
    <meta itemProp="image" content={`${config.siteUrl}${ogImagePath}?v=${Date.now()}`} />
    ...
    <meta name="twitter:image" content={`${config.siteUrl}${ogImagePath}?v=${Date.now()}`} />
